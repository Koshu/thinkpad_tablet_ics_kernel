...
#define SPI_PACKET_SIZE		128 		/* packet exchange with digitizer always 128 bytes	*/
#define SPI_HEADER_SIZE 	4   		/* 1byte type, 2bytes length, 1 byte flags		*/
#define INPUT_MAX_PACKET_SIZE	128		/* maximal input packet is 128 bytes			*/

/** Code for application commands that provide SPI-specific data (channel & function).
 * Command structure:
