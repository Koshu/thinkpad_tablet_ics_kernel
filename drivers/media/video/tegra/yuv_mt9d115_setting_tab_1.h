...
/* Compal Indigo-Carl for CTS 0711 begin */
...
/* Compal Indigo-Carl for CTS 0711 end */
...
{0x098C, 0xA24F},
{0x0990, 0x0087},	// 135  //origin: 0x0096(150)  //Compal ++
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_1[] = {
{0x098C, 0xA24F},
{0x0990, 0x006E},	// 110  //origin: 0x0078(110)  //Compal ++
{SENSOR_TABLE_END, 0x0000}
};

static struct sensor_reg Exposure_0[] = {
{0x098C, 0xA24F},
{0x0990, 0x0055},	// 85  //origin: 0x005C(92)  //Compal ++
{SENSOR_TABLE_END, 0x0000}
};
...
{0x098C, 0xA24F},
{0x0990, 0x0023},	// 35  //origin: 0x001E(30)  //Compal ++
{SENSOR_TABLE_END, 0x0000}
};
...
enum {
	...
	SENSOR_MODE_1280x960,	    // Compal Indigo-Carl for CTS 0711
...
static struct sensor_reg *mode_table[] = {
	...
	[SENSOR_MODE_1280x960]  = mode_1280x960,  // Compal Indigo-Carl for CTS 0711
