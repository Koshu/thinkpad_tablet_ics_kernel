...
static const struct tegra_emc_table ventana_emc_tables_Samsung_8Gb_300Mhz[] = {
               {
		.rate = 25000,   /* SDRAM frequency */
		.regs = {
			0x00000002,   /* RC */
...
static const struct tegra_emc_chip elpida_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = ventana_emc_tables_elpida_8Gb_300Mhz,
		.table_size = ARRAY_SIZE(ventana_emc_tables_elpida_8Gb_300Mhz)
	},
};

static const struct tegra_emc_chip hynix_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = ventana_emc_tables_Hynix_8Gb_300Mhz,
		.table_size = ARRAY_SIZE(ventana_emc_tables_Hynix_8Gb_300Mhz)
	},
};

static const struct tegra_emc_chip samsung_emc_chips[] = {
	{
		...
		.mem_revision_id2 = -1,
		.mem_pid = -1,
		.table = ventana_emc_tables_Samsung_8Gb_300Mhz,
		.table_size = ARRAY_SIZE(ventana_emc_tables_Samsung_8Gb_300Mhz)
	},
};
...
int ventana_emc_init(void)
{
	...
	switch(strap){
		case 0:
			...
			tegra_init_emc(elpida_emc_chips,
				ARRAY_SIZE(elpida_emc_chips));
			break;
		case 1:
			pr_info("%s: Hynix 1GB memory found\n", __func__);
			tegra_init_emc(hynix_emc_chips,
				ARRAY_SIZE(hynix_emc_chips));
			break;
		case 2:
			pr_info("%s: Samsung 1GB memory found\n", __func__);
			tegra_init_emc(samsung_emc_chips,
				ARRAY_SIZE(samsung_emc_chips));
			break;
		default:
